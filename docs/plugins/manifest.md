...
read_when:
  - You are building a FlowHelm plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (flowhelm.plugin.json)

Every plugin **must** ship a `flowhelm.plugin.json` file in the **plugin root**.
FlowHelm uses this manifest to validate configuration **without executing plugin
