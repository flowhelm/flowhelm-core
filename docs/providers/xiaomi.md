---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with FlowHelm"
read_when:
  - You want Xiaomi MiMo models in FlowHelm
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). FlowHelm uses
