---
summary: "Use Qianfan's unified API to access many models in FlowHelm"
read_when:
...
3. FlowHelm installed on your system
...
4. Copy the API key for use with FlowHelm

## CLI setup

```bash
flowhelm onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FlowHelm Configuration](/gateway/configuration)
