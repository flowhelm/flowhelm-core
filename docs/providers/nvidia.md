---
summary: "Use NVIDIA's OpenAI-compatible API in FlowHelm"
read_when:
  - You want to use NVIDIA models in FlowHelm
...
flowhelm onboard --auth-choice skip
flowhelm models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
