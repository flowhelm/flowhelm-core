---
summary: "Use Qwen OAuth (free tier) in FlowHelm"
read_when:
  - You want to use Qwen with FlowHelm
...
If you already logged in with the Qwen Code CLI, FlowHelm will sync credentials
