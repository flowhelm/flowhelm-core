...
You can point FlowHelm at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FlowHelm
...
- [Anthropic provider](/providers/anthropic) - Native FlowHelm integration with Claude setup-token or API keys
