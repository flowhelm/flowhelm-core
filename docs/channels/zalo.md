...
- Install via CLI: `flowhelm plugins install @flowhelm/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `flowhelm plugins install ./extensions/zalo`
   - From npm (if published): `flowhelm plugins install @flowhelm/zalo`
...
- Approve via:
  - `flowhelm pairing list zalo`
  - `flowhelm pairing approve zalo <CODE>`
...
- Example: `flowhelm message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `flowhelm channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `flowhelm logs --follow`
