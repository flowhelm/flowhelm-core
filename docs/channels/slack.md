...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure FlowHelm HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `flowhelm pairing approve slack <code>`.
...
FlowHelm supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, FlowHelm falls back to normal delivery for remaining payloads.
