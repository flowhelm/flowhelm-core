...
read_when:
  - You want FlowHelm to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables FlowHelm to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`flowhelm onboard`) and `flowhelm channels add` list optional channel plugins.
...
```bash
flowhelm plugins install @flowhelm/nostr
```

Use a local checkout (dev workflows):

```bash
flowhelm plugins install --link <path-to-flowhelm>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "flowhelm",
        "displayName": "FlowHelm",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "flowhelm@example.com",
        "lud16": "flowhelm@example.com"
      }
    }
  }
}
