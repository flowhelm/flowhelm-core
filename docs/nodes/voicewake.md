...
FlowHelm treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.flowhelm/settings/voicewake.json`

Shape:

```json
{ "triggers": ["flowhelm", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
