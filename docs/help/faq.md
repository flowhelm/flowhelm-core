---
summary: "Frequently asked questions about FlowHelm setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up FlowHelm?](#whats-the-recommended-way-to-install-and-set-up-flowhelm)
  ...
  - [I can't access docs.flowhelm.ai (SSL error). What now?](#i-cant-access-docsflowhelmai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or flowhelm not recognized](#windows-install-says-git-not-found-or-flowhelm-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install FlowHelm on Linux?](#how-do-i-install-flowhelm-on-linux)
  - [How do I install FlowHelm on a VPS?](#how-do-i-install-flowhelm-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask FlowHelm to update itself?](#can-i-ask-flowhelm-to-update-itself)
  ...
  - [If I buy a Mac mini to run FlowHelm, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-flowhelm-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different FlowHelm instances?](#can-multiple-people-use-one-whatsapp-number-with-different-flowhelm-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run FlowHelm on a dedicated machine?](#how-important-is-it-to-run-flowhelm-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run FlowHelm in a VM and what are the requirements](#can-i-run-flowhelm-in-a-vm-and-what-are-the-requirements)
- [What is FlowHelm?](#what-is-flowhelm)
  - [What is FlowHelm, in one paragraph?](#what-is-flowhelm-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for FlowHelm](#what-are-the-top-five-everyday-use-cases-for-flowhelm)
  - [Can FlowHelm help with lead gen outreach ads and blogs for a SaaS](#can-flowhelm-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can FlowHelm run tasks on a schedule or continuously in the background?](#can-flowhelm-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with FlowHelm saved locally?](#is-all-data-used-with-flowhelm-saved-locally)
  - [Where does FlowHelm store its data?](#where-does-flowhelm-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall FlowHelm?](#how-do-i-completely-uninstall-flowhelm)
...
- [Config basics](#config-basics)
  ...
  - [Can the FlowHelm browser run headless?](#can-the-flowhelm-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two FlowHelm instances talk to each other (local + VPS)?](#can-two-flowhelm-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does FlowHelm load environment variables?](#how-does-flowhelm-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of FlowHelm instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-flowhelm-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset FlowHelm but keep it installed?](#how-do-i-completely-reset-flowhelm-but-keep-it-installed)
  ...
  - [Why doesn't FlowHelm reply in a group?](#why-doesnt-flowhelm-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do FlowHelm, Flawd, and Krill use for models?](#what-do-flowhelm-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `flowhelm gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-flowhelm-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `flowhelm gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-flowhelm-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run FlowHelm in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-flowhelm-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart FlowHelm?](#i-closed-my-terminal-on-windows-how-do-i-restart-flowhelm)
  ...
  - [ELI5: `flowhelm gateway restart` vs `flowhelm gateway`](#eli5-flowhelm-gateway-restart-vs-flowhelm-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose FlowHelm to inbound DMs?](#is-it-safe-to-expose-flowhelm-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/flowhelm/flowhelm-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   flowhelm health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://flowhelm.ai/install.sh | bash -s -- --install-method git
```

This installs FlowHelm **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/flowhelm/flowhelm/issues](https://github.com/flowhelm/flowhelm/issues)
[https://github.com/flowhelm/flowhelm/pulls](https://github.com/flowhelm/flowhelm/pulls)

Start with these commands (share outputs when asking for help):

```bash
flowhelm status
flowhelm models status
flowhelm doctor
```

What they do:

- `flowhelm status`: quick snapshot of gateway/agent health + basic config.
- `flowhelm models status`: checks provider auth + model availability.
- `flowhelm doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `flowhelm status --all`, `flowhelm logs --follow`,
`flowhelm gateway status`, `flowhelm health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up FlowHelm

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://flowhelm.ai/install.sh | bash
flowhelm onboard --install-daemon
```
...
```bash
git clone https://github.com/flowhelm/flowhelm.git
cd flowhelm
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm flowhelm onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `FLOWHELM_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `flowhelm config get gateway.auth.token` (or generate one: `flowhelm doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `flowhelm gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `flowhelm gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install FlowHelm on the new machine.
2. Copy `$FLOWHELM_STATE_DIR` (default: `~/.flowhelm`) from the old machine.
3. Copy your workspace (default: `~/.flowhelm/workspace`).
4. Run `flowhelm doctor` and restart the Gateway service.
...
under `~/.flowhelm/` (for example `~/.flowhelm/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-flowhelm-store-its-data),
...
[https://github.com/flowhelm/flowhelm/blob/main/CHANGELOG.md](https://github.com/flowhelm/flowhelm/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.flowhelm.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.flowhelm.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.flowhelm.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsflowhelmai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/flowhelm/flowhelm/tree/main/docs](https://github.com/flowhelm/flowhelm/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://flowhelm.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://flowhelm.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://flowhelm.ai/install.ps1](https://flowhelm.ai/install.ps1)
...
```bash
curl -fsSL https://flowhelm.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://flowhelm.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://flowhelm.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://flowhelm.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or flowhelm not recognized
...
**2) flowhelm is not recognized after install**
...
### How do I install FlowHelm on Linux
...
### How do I install FlowHelm on a VPS
...
### Can I ask FlowHelm to update itself
...
```bash
flowhelm update
flowhelm update status
flowhelm update --channel stable|beta|dev
flowhelm update --tag <dist-tag|version>
flowhelm update --no-restart
```

If you must automate from an agent:

```bash
flowhelm update --yes --no-restart
flowhelm gateway restart
```
...
`flowhelm onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run FlowHelm with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `flowhelm models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `flowhelm models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `flowhelm models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. FlowHelm no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so FlowHelm can keep replying while a provider is rate-limited.
...
FlowHelm supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. FlowHelm fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `flowhelm.json`.

Steps:

1. Enable the plugin: `flowhelm plugins enable google-gemini-cli-auth`
2. Login: `flowhelm models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. FlowHelm needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. FlowHelm runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run FlowHelm can I connect it to my MacBook Pro
...
- Use `flowhelm nodes status` / `flowhelm nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but FlowHelm authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `flowhelm logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different FlowHelm instances
...
If you run FlowHelm via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the FlowHelm code install. Your state
(`~/.flowhelm`) and workspace (`~/.flowhelm/workspace`) stay untouched.
...
**FlowHelm-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run FlowHelm on a dedicated machine
...
FlowHelm is lightweight. For a basic Gateway + one chat channel:
...
### Can I run FlowHelm in a VM and what are the requirements
...
### What is FlowHelm in one paragraph

FlowHelm is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

FlowHelm is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for FlowHelm
...
### Can FlowHelm help with lead gen outreach ads and blogs for a SaaS
...
FlowHelm draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

FlowHelm is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use FlowHelm when you
...
Showcase: [https://flowhelm.ai/showcase](https://flowhelm.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.flowhelm/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.flowhelm/flowhelm.json`). Precedence is `<workspace>/skills` > `~/.flowhelm/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.flowhelm/flowhelm.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.flowhelm/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which FlowHelm treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `FLOWHELM_SKIP_CRON` is not set.
...
```bash
flowhelm cron run <jobId> --force
flowhelm cron runs --id <jobId> --limit 50
```
...
### Can FlowHelm run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.flowhelm.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-flowhelm-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. FlowHelm can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.flowhelm/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "flowhelm": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured FlowHelm workspace); FlowHelm treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.flowhelm/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
flowhelm browser extension install
flowhelm browser extension path
```
...
- Persist `/home/node` with `FLOWHELM_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `FLOWHELM_DOCKER_APT_PACKAGES`.
...
FlowHelm memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

FlowHelm also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, FlowHelm auto-selects a provider when it
...
configured and present, FlowHelm
prefers `local`.
...
### Is all data used with FlowHelm saved locally

No - **FlowHelm's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.flowhelm` + your workspace directory).
...
### Where does FlowHelm store its data

Everything lives under `$FLOWHELM_STATE_DIR` (default: `~/.flowhelm`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$FLOWHELM_STATE_DIR/flowhelm.json`                             | Main config (JSON5)                                          |
| `$FLOWHELM_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$FLOWHELM_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$FLOWHELM_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$FLOWHELM_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$FLOWHELM_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$FLOWHELM_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$FLOWHELM_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.flowhelm/agent/*` (migrated by `flowhelm doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.flowhelm/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.flowhelm`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.flowhelm`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.flowhelm/skills`).

Default workspace is `~/.flowhelm/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.flowhelm/workspace" } },
}
```
...
Do **not** commit anything under `~/.flowhelm` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall FlowHelm
...
`workspace` to the repo root. The FlowHelm repo is just source code; keep the
...
FlowHelm reads an optional **JSON5** config from `$FLOWHELM_CONFIG_PATH` (default: `~/.flowhelm/flowhelm.json`):

```
$FLOWHELM_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.flowhelm/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `FLOWHELM_GATEWAY_TOKEN`).
...
FlowHelm enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `flowhelm doctor --generate-gateway-token`.
...
key. **Recommended:** run `flowhelm configure --section web` to store it in
...
- Daemons read env vars from `~/.flowhelm/.env` (or the service environment).
...
### Can the FlowHelm browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   flowhelm nodes pending
   flowhelm nodes approve <requestId>
   ```
...
- Gateway is running: `flowhelm gateway status`
- Gateway health: `flowhelm status`
- Channel health: `flowhelm channels status`
...
### Can two FlowHelm instances talk to each other local VPS
...
`flowhelm agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
flowhelm agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.flowhelm/flowhelm.json`).
- If you have no backup, re-run `flowhelm doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `flowhelm config set` for small changes.
- Use `flowhelm configure` for interactive edits.
...
```bash
flowhelm gateway --tailscale serve
```
...
### How does FlowHelm load environment variables

FlowHelm reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.flowhelm/.env` (aka `$FLOWHELM_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.flowhelm/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`FLOWHELM_LOAD_SHELL_ENV=1`, `FLOWHELM_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`flowhelm models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means FlowHelm won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.flowhelm/.env`:
...
### Is there a way to make a team of FlowHelm instances one CEO and many agents
...
### How do I completely reset FlowHelm but keep it installed
...
```bash
flowhelm reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `FLOWHELM_PROFILE`), reset each state dir (defaults are `~/.flowhelm-<profile>`).
- Dev reset: `flowhelm gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), FlowHelm skips the heartbeat run to save API calls.
...
No. FlowHelm runs on **your own account**, so if you're in the group, FlowHelm can see it.
...
```bash
flowhelm directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't FlowHelm reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.flowhelm/agents/<agentId>/sessions/`.
...
- Use `flowhelm doctor` to spot stray workspaces and profile mismatches.
...
FlowHelm's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, FlowHelm currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `flowhelm models set ...` (updates just model config)
- `flowhelm configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.flowhelm/flowhelm.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `flowhelm doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do FlowHelm, Flawd, and Krill use for models

- **FlowHelm + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. FlowHelm ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.flowhelm/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `flowhelm agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so FlowHelm can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.flowhelm/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.flowhelm/agent/*` (migrated by `flowhelm doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.flowhelm/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `flowhelm models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `flowhelm models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `flowhelm models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.flowhelm/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    flowhelm models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), FlowHelm will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: FlowHelm now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
FlowHelm uses provider-prefixed IDs like:
...
FlowHelm may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `flowhelm models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
flowhelm models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
flowhelm models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
flowhelm models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
flowhelm models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

FlowHelm supports both:
...
```
--port > FLOWHELM_GATEWAY_PORT > gateway.port > default 18789
```

### Why does flowhelm gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `flowhelm gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does flowhelm gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `FLOWHELM_STATE_DIR` mismatch).

Fix:

```bash
flowhelm gateway install --force
```
...
FlowHelm enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `flowhelm gateway --port <port>`.

### How do I run FlowHelm in remote mode client connects to a Gateway elsewhere
...
- `flowhelm gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `flowhelm.control.settings.v1`.

Fix:

- Fastest: `flowhelm dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `flowhelm doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `FLOWHELM_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `flowhelm status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `FLOWHELM_CONFIG_PATH` (per-instance config)
- `FLOWHELM_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `flowhelm --profile <name> …` per instance (auto-creates `~/.flowhelm-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `flowhelm --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.flowhelm.*`, `flowhelm-gateway-<profile>.service`, `FlowHelm Gateway (<profile>)`).
...
```
flowhelm tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/flowhelm/flowhelm-YYYY-MM-DD.log
```
...
- macOS: `$FLOWHELM_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.flowhelm/logs/...`; profiles use `~/.flowhelm-<profile>/logs/...`)
- Linux: `journalctl --user -u flowhelm-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "FlowHelm Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `flowhelm gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart FlowHelm
...
1. Is the Gateway running? `flowhelm gateway status`
2. Is the Gateway healthy? `flowhelm status`
3. Does the UI have the right token? `flowhelm dashboard`
...
```bash
flowhelm channels status
flowhelm channels logs --channel telegram
```
...
### ELI5 flowhelm gateway restart vs flowhelm gateway

- `flowhelm gateway restart`: restarts the **background service** (launchd/systemd).
- `flowhelm gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `flowhelm gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [FlowHelm assistant setup](/start/flowhelm) and [Agent send](/tools/agent-send).

CLI sending:

```bash
flowhelm message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose FlowHelm to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `flowhelm pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `flowhelm pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `flowhelm doctor` to surface risky DM policies.
...
```bash
flowhelm pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. FlowHelm only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
flowhelm pairing approve whatsapp <code>
```

List pending requests:

```bash
flowhelm pairing list whatsapp
```
...
FlowHelm blocks **cross-provider** messaging by default. If a tool call is bound
