...
FlowHelm ships three update channels:
...
When you **explicitly** switch channels with `--channel`, FlowHelm also aligns
the install method:
...
When you switch channels with `flowhelm update`, FlowHelm also syncs plugin sources:
