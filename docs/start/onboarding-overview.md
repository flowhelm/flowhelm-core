---
summary: "Overview of FlowHelm onboarding options and flows"
read_when:
...
FlowHelm supports multiple onboarding paths depending on where the Gateway runs
...
- [`flowhelm onboard` command](/cli/onboard)

## macOS app onboarding

Use the FlowHelm app when you want a fully guided setup on macOS. Docs:
