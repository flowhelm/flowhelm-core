---
summary: "First-run onboarding flow for FlowHelm (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give FlowHelm">
...
<Step title="CLI">
  ...
  The app can install the global `flowhelm` CLI via npm/pnpm so terminal
