...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.flowhelm.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to FlowHelm", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to FlowHelm gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to FlowHelm.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "FlowHelmShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "FlowHelm is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "FlowHelm Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("flowhelm-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
