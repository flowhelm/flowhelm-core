...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FlowHelmPhotosLatestParams) async throws -> FlowHelmPhotosLatestPayload {
        ...
        var results: [FlowHelmPhotoPayload] = []
        ...
        return FlowHelmPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FlowHelmPhotoPayload
    {
