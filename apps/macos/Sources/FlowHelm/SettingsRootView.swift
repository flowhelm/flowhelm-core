...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .flowhelmSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FlowHelmPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FlowHelmPaths.stateDirURL.path
...
extension Notification.Name {
    static let flowhelmSelectSettingsTab = Notification.Name("flowhelmSelectSettingsTab")
}
