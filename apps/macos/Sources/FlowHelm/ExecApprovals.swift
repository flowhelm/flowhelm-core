...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.flowhelm", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        FlowHelmPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        FlowHelmPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
