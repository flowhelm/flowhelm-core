...
enum UIStrings {
    static let welcomeTitle = "Welcome to FlowHelm"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "flowhelm.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: FlowHelmOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: FlowHelmChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g flowhelm@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FlowHelmChatViewModel(
