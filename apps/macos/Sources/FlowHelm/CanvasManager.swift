...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.flowhelm", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("FlowHelm/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__flowhelm__/a2ui/").absoluteString + "?platform=macos"
    }
