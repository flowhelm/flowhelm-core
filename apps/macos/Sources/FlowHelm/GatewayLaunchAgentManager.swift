...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.flowhelm", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".flowhelm/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.flowhelmCommand(
            subcommand: "gateway",
