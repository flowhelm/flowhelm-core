...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FlowHelmConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FlowHelmConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = FlowHelmConfigFile.loadDict()
            ...
            FlowHelmConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/flowhelm"
        state.remoteCliPath = ""
        return state
    }
}
