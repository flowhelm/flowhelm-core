...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.flowhelm", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FlowHelm windows, but below the system’s pop-up menus.
