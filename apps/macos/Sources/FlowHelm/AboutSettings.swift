...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/flowhelm/flowhelm") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/flowhelm/flowhelm")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://flowhelm.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "FlowHelmBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FlowHelmBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FlowHelmGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FlowHelmGitCommit") as? String) ??
            "unknown"
    }
