...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (FlowHelm token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: FlowHelmOAuthStore.AnthropicOAuthStatus = FlowHelmOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.flowhelm", category: "anthropic-oauth")
...
enum FlowHelmOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let flowhelmOAuthDirEnv = "FLOWHELM_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "FlowHelm OAuth token file not found"
            case .unreadableFile: "FlowHelm OAuth token file not readable"
            case .invalidJSON: "FlowHelm OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in FlowHelm OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "FlowHelm OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.flowhelmOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".flowhelm", isDirectory: true)
