...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.flowhelm", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.flowhelm", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [FlowHelmChatMessage] = messages.compactMap { item in
