...
enum FlowHelmConfigFile {
    private static let logger = Logger(subsystem: "ai.flowhelm", category: "config")
    ...
    static func stateDirURL() -> URL {
        FlowHelmPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        FlowHelmPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-flowhelm-config-file",
            "event": "config.write",
