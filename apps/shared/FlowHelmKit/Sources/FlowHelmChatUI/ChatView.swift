...
@MainActor
public struct FlowHelmChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: FlowHelmChatViewModel
    ...
    public init(
        viewModel: FlowHelmChatViewModel,
    ...
    private var visibleMessages: [FlowHelmChatMessage] {
        let base: [FlowHelmChatMessage]
    ...
    private func mergeToolResults(in messages: [FlowHelmChatMessage]) -> [FlowHelmChatMessage] {
        ...
        for message in messages {
            ...
            let merged = FlowHelmChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: FlowHelmChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: FlowHelmChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: FlowHelmChatMessage) -> String {
