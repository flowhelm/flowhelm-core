...
public typealias FlowHelmPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FlowHelmPlatformImage = UIImage
#endif

public struct FlowHelmChatUsageCost: Codable, Hashable, Sendable {
...
public struct FlowHelmChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FlowHelmChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FlowHelmChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FlowHelmChatMessageContent: Codable, Hashable, Sendable {
...
public struct FlowHelmChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FlowHelmChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FlowHelmChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FlowHelmChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FlowHelmChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FlowHelmChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FlowHelmChatMessageContent].self, forKey: .content) {
...
public struct FlowHelmChatHistoryPayload: Codable, Sendable {
...
public struct FlowHelmSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FlowHelmSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FlowHelmSessionPreviewItem]
}

public struct FlowHelmSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FlowHelmSessionPreviewEntry]

    public init(ts: Int, previews: [FlowHelmSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FlowHelmChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FlowHelmChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FlowHelmAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FlowHelmChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FlowHelmGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FlowHelmPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FlowHelmPlatformImage?
...
public struct FlowHelmChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
