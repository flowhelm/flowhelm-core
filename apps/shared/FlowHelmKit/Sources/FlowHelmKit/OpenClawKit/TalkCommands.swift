...
public enum FlowHelmTalkCommand: String, Codable, Sendable {
...
public struct FlowHelmTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct FlowHelmTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
