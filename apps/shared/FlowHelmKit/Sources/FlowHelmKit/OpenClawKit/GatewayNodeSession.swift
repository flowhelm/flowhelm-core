...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.flowhelm", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.flowhelm", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: FlowHelmProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
