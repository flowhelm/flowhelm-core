...
public enum FlowHelmCanvasA2UICommand: String, Codable, Sendable {
...
public struct FlowHelmCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FlowHelmCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
