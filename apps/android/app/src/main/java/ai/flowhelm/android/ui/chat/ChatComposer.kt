...
import ai.flowhelm.android.ui.mobileSurface
import ai.flowhelm.android.ui.mobileText
import ai.flowhelm.android.ui.mobileTextSecondary
import ai.flowhelm.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.flowhelm.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.flowhelm.android.ui.mobileFontFamily,
