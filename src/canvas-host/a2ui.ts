...
export const A2UI_PATH = "/__flowhelm__/a2ui";

export const CANVAS_HOST_PATH = "/__flowhelm__/canvas";

export const CANVAS_WS_PATH = "/__flowhelm__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.flowhelmCanvasA2UIAction.postMessage(...)
  // - Android: window.flowhelmCanvasA2UIAction.postMessage(...)
  const handlerNames = ["flowhelmCanvasA2UIAction"];
  ...
  globalThis.FlowHelm = globalThis.FlowHelm ?? {};
  globalThis.FlowHelm.postMessage = postToNode;
  globalThis.FlowHelm.sendUserAction = sendUserAction;
  globalThis.flowhelmPostMessage = postToNode;
  globalThis.flowhelmSendUserAction = sendUserAction;
