...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.FLOWHELM_TTS_PREFS;
      process.env.FLOWHELM_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.FLOWHELM_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: FlowHelmConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
