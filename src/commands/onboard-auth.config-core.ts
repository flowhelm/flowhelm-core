...
export function applyOpenrouterProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: FlowHelmConfig): FlowHelmConfig {
...
export function applyMoonshotConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: FlowHelmConfig): FlowHelmConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: FlowHelmConfig): FlowHelmConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: FlowHelmConfig): FlowHelmConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: FlowHelmConfig): FlowHelmConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: FlowHelmConfig): FlowHelmConfig {
...
export function applyQianfanProviderConfig(cfg: FlowHelmConfig): FlowHelmConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: FlowHelmConfig): FlowHelmConfig {
