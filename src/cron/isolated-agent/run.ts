...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/flowhelm/flowhelm/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.FLOWHELM_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.flowhelm/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: FlowHelmConfig = {
    ...params.cfg,
