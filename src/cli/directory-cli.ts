    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["flowhelm directory self --channel slack", "Show the connected account identity."],
          [
            'flowhelm directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["flowhelm directory groups list --channel discord", "List available groups/channels."],
          [
            "flowhelm directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.flowhelm.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
