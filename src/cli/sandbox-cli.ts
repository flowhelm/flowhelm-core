...
const SANDBOX_EXAMPLES = {
  main: [
    ["flowhelm sandbox list", "List all sandbox containers."],
    ["flowhelm sandbox list --browser", "List only browser containers."],
    ["flowhelm sandbox recreate --all", "Recreate all containers."],
    ["flowhelm sandbox recreate --session main", "Recreate a specific session."],
    ["flowhelm sandbox recreate --agent mybot", "Recreate agent containers."],
    ["flowhelm sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["flowhelm sandbox list", "List all sandbox containers."],
    ["flowhelm sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["flowhelm sandbox recreate --all", "Recreate all containers."],
    ["flowhelm sandbox recreate --session main", "Recreate a specific session."],
    ["flowhelm sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["flowhelm sandbox recreate --browser --all", "Recreate only browser containers."],
    ["flowhelm sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["flowhelm sandbox explain", "Show effective sandbox config."],
    ["flowhelm sandbox explain --session agent:main:main", "Explain a specific session."],
    ["flowhelm sandbox explain --agent work", "Explain an agent sandbox."],
    ["flowhelm sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.flowhelm.ai/cli/sandbox")}\n`,
    )
    .action(() => {
