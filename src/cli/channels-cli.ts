    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["flowhelm channels list", "List configured channels and auth profiles."],
          ["flowhelm channels status --probe", "Run channel status checks and probes."],
          [
            "flowhelm channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["flowhelm channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.flowhelm.ai/cli/channels",
        )}\n`,
    );
