...
export function listWhatsAppAuthDirs(cfg: FlowHelmConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FlowHelmConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FlowHelmConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FlowHelmConfig): ResolvedWhatsAppAccount[] {
