...
function resolveAvatarSource(cfg: FlowHelmConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FlowHelmConfig, agentId: string): AgentAvatarResolution {
