...
function asFlowHelmConfig(config: Partial<FlowHelmConfig>): FlowHelmConfig {
  return config as FlowHelmConfig;
}

function createToolConfig() {
  return asFlowHelmConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: FlowHelmConfig = createToolConfig()) {
