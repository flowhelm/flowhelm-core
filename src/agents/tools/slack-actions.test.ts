...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): FlowHelmConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: FlowHelmConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: FlowHelmConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
