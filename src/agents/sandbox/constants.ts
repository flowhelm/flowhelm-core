...
export const DEFAULT_SANDBOX_IMAGE = "flowhelm-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "flowhelm-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "flowhelm-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "flowhelm-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "flowhelm-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "flowhelm-sandbox-browser";
