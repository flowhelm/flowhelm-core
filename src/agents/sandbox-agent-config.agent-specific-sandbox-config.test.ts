...
async function resolveContext(config: FlowHelmConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): FlowHelmConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
