...
import { resolveFlowHelmDocsPath } from "../../docs-path.js";
...
import { createFlowHelmCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveFlowHelmAgentDir();
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/flowhelm/flowhelm/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("flowhelm:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/flowhelm/flowhelm/issues/8643
