...
function resolveAdaptiveReadMaxBytes(options?: FlowHelmReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFlowHelmReadTool(base, {
...
export function createFlowHelmReadTool(
  base: AnyAgentTool,
  options?: FlowHelmReadToolOptions,
): AnyAgentTool {
