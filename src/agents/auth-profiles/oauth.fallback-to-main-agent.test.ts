...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveFlowHelmAgentDir() returns mainAgentDir
    process.env.FLOWHELM_STATE_DIR = tmpDir;
    process.env.FLOWHELM_AGENT_DIR = mainAgentDir;
