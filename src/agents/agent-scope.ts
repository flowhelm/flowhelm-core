...
type AgentEntry = NonNullable<NonNullable<FlowHelmConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: FlowHelmConfig): AgentEntry[] {
...
export function listAgentIds(cfg: FlowHelmConfig): string[] {
...
export function resolveDefaultAgentId(cfg: FlowHelmConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: FlowHelmConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: FlowHelmConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: FlowHelmConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: FlowHelmConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
