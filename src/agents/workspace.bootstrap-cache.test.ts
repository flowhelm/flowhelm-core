...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("flowhelm-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("flowhelm-cache-test1-");
    const workspace2 = await makeTempWorkspace("flowhelm-cache-test2-");
