...
function resolveWatchPaths(workspaceDir: string, config?: FlowHelmConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: FlowHelmConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FlowHelmConfig }) {
