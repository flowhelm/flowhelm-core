...
export function listChannelMessageActions(cfg: FlowHelmConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FlowHelmConfig): boolean {
...
export function supportsChannelMessageCards(cfg: FlowHelmConfig): boolean {
