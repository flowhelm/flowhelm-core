...
export type ChannelAgentToolFactory = (params: { cfg?: FlowHelmConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FlowHelmConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: FlowHelmConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FlowHelmConfig }) => boolean;
  supportsCards?: (params: { cfg: FlowHelmConfig }) => boolean;
