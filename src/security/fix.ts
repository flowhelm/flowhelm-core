...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FlowHelmConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FlowHelmConfig; env: NodeJS.ProcessEnv }): {
  cfg: FlowHelmConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
