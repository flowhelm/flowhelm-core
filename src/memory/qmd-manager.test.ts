...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: FlowHelmConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: FlowHelmConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__flowhelmMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__flowhelmMcporterColdStartWarned;
  });
