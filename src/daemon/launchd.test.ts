...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.flowhelm.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", FLOWHELM_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.flowhelm.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.flowhelm.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when FLOWHELM_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.flowhelm.gateway.plist",
    },
    {
      name: "uses profile-specific label when FLOWHELM_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", FLOWHELM_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.flowhelm.jbphoenix.plist",
    },
    {
      name: "prefers FLOWHELM_LAUNCHD_LABEL over FLOWHELM_PROFILE",
      env: {
        HOME: "/Users/test",
        FLOWHELM_PROFILE: "jbphoenix",
        FLOWHELM_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from FLOWHELM_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        FLOWHELM_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty FLOWHELM_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        FLOWHELM_PROFILE: "myprofile",
        FLOWHELM_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.flowhelm.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
