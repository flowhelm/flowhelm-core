...
import {
  probeAuthenticatedFlowHelmRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated flowhelm relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedFlowHelmRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-flowhelm-relay-token",
