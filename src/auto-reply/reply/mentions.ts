...
function resolveMentionPatterns(cfg: FlowHelmConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FlowHelmConfig | undefined, agentId?: string): RegExp[] {
