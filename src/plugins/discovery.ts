...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @flowhelm/voice-call -> voice-call).
...
export function discoverFlowHelmPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".flowhelm", "extensions")];
