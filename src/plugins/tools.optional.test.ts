...
const loadFlowHelmPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadFlowHelmPlugins: (params: unknown) => loadFlowHelmPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadFlowHelmPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadFlowHelmPluginsMock.mockClear();
  });
