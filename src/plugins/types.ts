...
export type FlowHelmPluginConfigSchema = {
...
export type FlowHelmPluginToolContext = {
...
export type FlowHelmPluginToolFactory = (
  ctx: FlowHelmPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type FlowHelmPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type FlowHelmPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<FlowHelmConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type FlowHelmPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current FlowHelm configuration */
  config: FlowHelmConfig;
 ...
 */
export type FlowHelmPluginCommandDefinition = {
...
export type FlowHelmPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type FlowHelmPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type FlowHelmPluginCliContext = {
  program: Command;
  config: FlowHelmConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type FlowHelmPluginCliRegistrar = (ctx: FlowHelmPluginCliContext) => void | Promise<void>;

export type FlowHelmPluginServiceContext = {
  config: FlowHelmConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type FlowHelmPluginService = {
  id: string;
  start: (ctx: FlowHelmPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: FlowHelmPluginServiceContext) => void | Promise<void>;
};

export type FlowHelmPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type FlowHelmPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: FlowHelmPluginConfigSchema;
  register?: (api: FlowHelmPluginApi) => void | Promise<void>;
  activate?: (api: FlowHelmPluginApi) => void | Promise<void>;
};

export type FlowHelmPluginModule =
  | FlowHelmPluginDefinition
  | ((api: FlowHelmPluginApi) => void | Promise<void>);

export type FlowHelmPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | FlowHelmPluginToolFactory,
    opts?: FlowHelmPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: FlowHelmPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: FlowHelmPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: FlowHelmPluginHttpRouteHandler }) => void;
  registerChannel: (registration: FlowHelmPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: FlowHelmPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: FlowHelmPluginService) => void;
   ...
   */
  registerCommand: (command: FlowHelmPluginCommandDefinition) => void;
