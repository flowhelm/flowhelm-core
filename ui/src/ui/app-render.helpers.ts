...
import { FlowHelmApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as FlowHelmApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as FlowHelmApp).resetToolStream();
  (state as unknown as FlowHelmApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as FlowHelmApp;
