...
if [[ -z "$version_content" ]]; then
  echo "<h2>FlowHelm $VERSION</h2>"
  echo "<p>Latest FlowHelm update.</p>"
  echo "<p><a href=\"https://github.com/flowhelm/flowhelm/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
