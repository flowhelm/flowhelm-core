...
show_usage() {
    cat << EOF
clawlog - FlowHelm Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View FlowHelm logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    FlowHelm logs flow through the macOS unified log (subsystem: ai.flowhelm).
