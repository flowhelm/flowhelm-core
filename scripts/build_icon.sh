...
# Defaults target the FlowHelm assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/FlowHelm/Resources/FlowHelm.icns"}
