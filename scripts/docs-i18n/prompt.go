...
- Keep product names in English: FlowHelm, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FlowHelm Gateway, use “Gateway 网关”.
