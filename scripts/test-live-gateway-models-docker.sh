...
docker run --rm -t \
  ...
  -e FLOWHELM_LIVE_GATEWAY_MODELS="${FLOWHELM_LIVE_GATEWAY_MODELS:-${FLOWHELM_BOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e FLOWHELM_LIVE_GATEWAY_PROVIDERS="${FLOWHELM_LIVE_GATEWAY_PROVIDERS:-${FLOWHELM_BOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e FLOWHELM_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${FLOWHELM_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${FLOWHELM_BOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
