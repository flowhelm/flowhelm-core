...
# Output:
# - dist/FlowHelm.app
# - dist/FlowHelm-<version>.zip
# - dist/FlowHelm-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.flowhelm.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/FlowHelm.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FlowHelm-$VERSION.zip"
DMG="$ROOT_DIR/dist/FlowHelm-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FlowHelm-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FlowHelm-$VERSION.dSYM.zip"
