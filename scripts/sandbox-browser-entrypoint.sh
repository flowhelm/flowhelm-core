...
export DISPLAY=:1
export HOME=/tmp/flowhelm-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${FLOWHELM_BROWSER_CDP_PORT:-${FLOWHELM_BOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${FLOWHELM_BROWSER_CDP_SOURCE_RANGE:-${FLOWHELM_BOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${FLOWHELM_BROWSER_VNC_PORT:-${FLOWHELM_BOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${FLOWHELM_BROWSER_NOVNC_PORT:-${FLOWHELM_BOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${FLOWHELM_BROWSER_ENABLE_NOVNC:-${FLOWHELM_BOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${FLOWHELM_BROWSER_HEADLESS:-${FLOWHELM_BOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${FLOWHELM_BROWSER_NO_SANDBOX:-${FLOWHELM_BOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${FLOWHELM_BROWSER_NOVNC_PASSWORD:-${FLOWHELM_BOT_BROWSER_NOVNC_PASSWORD:-}}"
